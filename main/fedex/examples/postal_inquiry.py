...
inquiry.Address.PostalCode = '110085'
inquiry.Address.CountryCode = 'IN'
inquiry.Address.StreetLines = ['test 123']
inquiry.Address.City = 'New Delhi'
inquiry.Address.StateOrProvinceCode = 'IN'
