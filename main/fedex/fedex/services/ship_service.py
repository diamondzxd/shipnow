...
class FedexProcessShipmentRequest(FedexBaseService):
    ...
    def add_commodity(self, commodity_item):
	    """
	    Adds a commodity item to the ship request.
	    @type commodity_item: WSDL object, type of Commodity - FIXIME
	    WSDL object.
	    @keyword commodity_item: A Commodity, created by
	    calling create_wsdl_object_of_type('Commodity') on
	    this ShipmentRequest object. See examples/create_international_shipment.py for
	    more details.
	    """
	    self.RequestedShipment.CustomsClearanceDetail.Commodities.append(commodity_item)
